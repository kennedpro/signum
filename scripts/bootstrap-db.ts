  ...
  try {
    ...
    console.log(
      result.superadminCreated
        ? "✓ Cuenta superadmin (Administrador de Plataforma) creada"
        : "✓ Cuenta superadmin disponible"
    );
    console.log(`✓ Cuentas sembradas en esta ejecución: ${result.usersCreated}`);
    console.log("\n  Usuario: superadmin                Contraseña: admin  (ve las dos empresas)");
    console.log("  Usuario: diana.ortiz@adip          Contraseña: admin  (empresa pública ADIP)");
    console.log("  Usuario: santiago.blandon@vantara  Contraseña: admin  (empresa privada Vantara)\n");
