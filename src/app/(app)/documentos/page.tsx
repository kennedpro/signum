...
import { desc, eq, ilike, and, inArray, or, sql, type SQL } from "drizzle-orm";
...
export default async function DocumentosPage({
  ...
  // Usuario normal: solo su organización. Admin de plataforma con entidad elegida
  // (cookie signum_org): esa entidad; sin elegir: todas.
  if (ctx.orgId) conditions.push(eq(documents.organizationId, ctx.orgId));
  else if (!ctx.isPlatformAdmin) conditions.push(sql`false`);
