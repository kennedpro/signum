...
import { currentUser } from "@/lib/inbox";
...
export default async function SeguridadPage() {
  /* ── RBAC: solo Jefe de Gestión Documental o Administrador ── */
  const me = await currentUser();
  const allowed = me?.systemRole === "jefe_gestion" || me?.systemRole === "admin";
  ...
  const chain = verifyChain(chrono.map((l) => ({ hash: l.hash, prevHash: l.prevHash })));
