...
export default async function VerificarPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div
        className={cn(
          "hud scanline hud-grid relative overflow-hidden rounded-xl p-6",
          valid ? "border-emerald-400/40" : "border-rose-500/40"
        )}
      >
        ...
        <div className="relative flex flex-wrap items-center justify-between gap-3">
          ...
          <span
            className={cn(
              "rounded px-3 py-1.5 font-mono text-[11px] font-bold",
              valid
                ? "pulse-ring bg-emerald-400/15 text-emerald-300"
