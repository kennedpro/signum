      ...
      <header className="sticky top-0 z-30 border-b border-line bg-deep/85 backdrop-blur-xl">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-3">
            <span className="grid h-9 w-9 place-items-center rounded-lg bg-gradient-to-br from-neon/25 to-plasma/20 ring-1 ring-neon/40">
              <Fingerprint className="h-4.5 w-4.5 text-neon" />
            </span>
            <div>
