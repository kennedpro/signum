...
/**
 * Pantalla de error GLOBAL (cuando falla incluso el layout raíz). Sustituye al
 * "Internal Server Error" en texto plano. Consulta /api/health para explicar, en lenguaje claro,
...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <html lang="es">
      <body style={{ margin: 0, background: "#050d12", color: "#e2e8f0", fontFamily: "system-ui, Segoe UI, Arial, sans-serif" }}>
