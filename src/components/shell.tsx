...
const NAV = [
  { href: "/", label: "Inicio", icon: LayoutDashboard, exact: true, restricted: false, platformOnly: false },
  { href: "/bandeja", label: "Bandeja", icon: Inbox, exact: false, restricted: false, platformOnly: false },
  { href: "/documentos", label: "Repositorio", icon: Files, exact: false, restricted: false, platformOnly: false },
  { href: "/plataforma", label: "Plataforma", icon: Globe2, exact: false, restricted: false, platformOnly: true },
  { href: "/usuarios", label: "Funcionarios", icon: IdCard, exact: false, restricted: true, platformOnly: false },
  { href: "/radicacion", label: "Libro radicador", icon: BookMarked, exact: false, restricted: true, platformOnly: false },
  { href: "/seguridad", label: "Seguridad", icon: ShieldAlert, exact: false, restricted: true, platformOnly: false },
  { href: "/organizacion", label: "Organización", icon: Building2, exact: false, restricted: false, platformOnly: false },
];
...
function getTitle(pathname: string): { title: string; sub: string; code: string } {
  ...
  if (pathname.startsWith("/plataforma"))
    return {
      title: "Plataforma",
      sub: "Empresas, entornos y usuarios de todo SIGNUM",
      code: "PLAT-900",
    };
  if (pathname.startsWith("/cuenta"))
    return { title: "Mi cuenta", sub: "Contraseña de acceso", code: "ACC-050" };
...
function NavList({
  ...
  return (
    <>
      {NAV.filter((n) => (!n.restricted || canSecurity) && (!n.platformOnly || isPlatformAdmin)).map((item) => {
        ...
        <div className="flex items-center gap-2.5 rounded-md border border-line bg-panel/40 p-2">
          ...
          <div className="flex shrink-0 flex-col gap-1">
            ...
            <button
              ...
              className="grid h-8 w-8 place-items-center rounded-md border border-line2 text-slate-500 transition hover:border-rose-500/50 hover:text-rose-400"
            >
