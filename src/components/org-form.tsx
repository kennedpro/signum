...
/** Persona de muestra usada en todas las previsualizaciones (ilustrativa). */
const DEMO = {
  name: "Ana María Torres Salazar",
  email: "ana.torres@correo.entidad.gov.co",
  grado: "Profesional Especializada",
  cedula: "1032456789",
  cargoPub: "Jefe de Oficina de Tecnología",
  cargoPriv: "Directora de Tecnología",
